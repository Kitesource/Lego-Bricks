...
export default defineComponent({
  ...
  setup () {
    const testData = {
      page: { props: { width: '375px', height: '622px', backgroundImage: 'url("https://vue-maker.oss-cn-hangzhou.aliyuncs.com/vue-marker/5f6ea094dc5a797fb46c1db5.jpg")'}},
      // 页面上面一个个组件的属性
      components: [
        {id: '123', name: 'l-text', props: { text: 'hello', top: '20', left: '20px'}},
